      ...
      <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
        ...
        <div>
          ...
          <ul class="text-white">
            ...
            <li class="mb-4">
              <a href="#" class="hover:underline">Curso Presencial DM</a>
            </li>
            <li class="mb-4">
              <a href="#" class="hover:underline">Curso HAS</a>
            </li>
            <li class="mb-4">
              <a href="#" class="hover:underline">Mais cursos</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul class="text-white">
            ...
            <li class="mb-4">
              <a href="#" class="hover:underline">Segurança</a>
            </li>
            <li class="mb-4">
              <a href="#" class="hover:underline">Termos de compromisso</a>
            </li>
          </ul>
        </div>
        <div>
          ...
          <ul class="text-white">
            ...
            <li class="mb-4">
              <a href="#" class="hover:underline">Spotify</a>
            </li>
            <li class="mb-4">
